                        ...
                        <div class="row product-micro-row">
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_tr)}}">@if(session()->get('language') == 'turkce') {{ $product->product_name_tr }} @else {{ $product->product_name_en }} @endif</a></h3>
