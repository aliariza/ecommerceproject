...
@endforeach <!-- //end Sub-Sub-Category FOREACH -->
          ...
          @include('frontend.product.partial.hotdeals')

          <!-- ========= HOT DEALS: END ========= -->

          <!-- ========= SPECIAL OFFER ========= -->

          @include('frontend.product.partial.special_offer')          
          ...
          @include('frontend.product.partial.product_tags')

          <!-- ============== PRODUCT TAGS : END ============ --> 

          <!-- ============== SPECIAL DEALS ================= -->

          @include('frontend.product.partial.special_deals')
        ...
        <!-- ================== INFO BOXES ===================== -->
          ...
          @include('frontend.product.partial.new_products')
          ...
          @include('frontend.product.partial.featured')
