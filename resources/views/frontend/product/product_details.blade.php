...
{{ $product->product_name_tr }} | Ürün Detayi
@endsection
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>{{ $product->product_name_tr }}</li>
			</ul>
...
@if(session()->get('language') == 'turkce') {{ $product->product_name_tr }} @else {{ $product->product_name_en }} @endif
							...
							<div class="description-container m-t-20">
								@if(session()->get('language') == 'turkce') {{ $product->short_descp_tr }} @else {{ $product->short_descp_en }} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">
                              @if(session()->get('language') == 'turkce') {!!$product->long_descp_tr!!} @else {!!$product->long_descp_en!!} @endif
