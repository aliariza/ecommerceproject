	...
	<div class="col-8">
	 ...
	 <div class="box">
		<div class="box-header with-border">
		  <h3 class="box-title">Alt-Alt Kategori  Listesi</h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
			  ...
			  <table id="example1" class="table table-bordered table-striped text-center">
				<thead>
					<tr>
						<th>Ana Kategori</th>
						<th>Alt Kategori</th>
						<th>Alt Alt Kategori (En)</th>
						<th>Alt Alt Kategori (Tr)</th>
						<th>Islemler</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						<td>{{ $item['category']['category_name_tr'] }}</td>
						<td>{{ $item['subcategory']['subcategory_name_tr'] }}</td>

						<td>{{ $item->subsubcategory_name_en }}</td>
						<td>{{ $item->subsubcategory_name_tr }}</td>

						<td class="d-flex justify-content-around">
							
							<a class="text-info" href="{{ route('subsubcategory.edit', $item->id) }}" title="Düzenle"><i class="fa fa-edit fa-lg"></i></a>

							<a class="text-danger" onclick="return confirm('Emin misiniz?')" href="{{route('subsubcategory.delete', $item->id)}}" title="Sil"><i class="fa fa-trash fa-lg"></i></a>
...
<!-- ------------- ADD Sub Sub Category PAGE ------------- -->
	<div class="col-4">
	 ...
	 <div class="box">
		<div class="box-header with-border">
		  <h3 class="box-title">Alt-Alt Kategori Ekle</h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
